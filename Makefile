...
deploy-account :; forge script $(if $(filter zksync,${chain}),--zksync) ${contract} --rpc-url ${chain} $(if ${dry},--sender 0x73AF3bcf944a6559933396c1577B257e2054D935 -vvvv, --account ${ACCOUNT_NAME} --verify -vvvv --slow --broadcast --verify)
