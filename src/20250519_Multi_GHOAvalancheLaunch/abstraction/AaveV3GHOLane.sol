...
abstract contract AaveV3GHOLane is IProposalGenericExecutor {
    ...
    function getChainLanesToAdd() external view returns (IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate[] memory) {
    ...
    function _asChainUpdate(
        ...
        return IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate({
    ...
    function _asChainUpdateWithDefaultRateLimiterConfig(GhoCCIPChains.ChainInfo memory chainInfo)
        internal
        pure
        returns (IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate memory)
    {
    ...
    function _asArray(IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate memory chainUpdate)
        internal
        pure
        returns (IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate[] memory)
    {
        IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate[] memory chainUpdates =
            new IUpgradeableBurnMintTokenPool_1_5_1.ChainUpdate[](1);
