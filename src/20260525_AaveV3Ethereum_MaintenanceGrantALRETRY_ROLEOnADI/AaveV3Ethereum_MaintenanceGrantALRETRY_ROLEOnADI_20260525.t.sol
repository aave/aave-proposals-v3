 ...
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260525_AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI/AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260525.t.sol -vv
 */
contract AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260525_Test is ProtocolV3TestBase {
  ...
  function setUp() public {
    ...
    proposal = new AaveV3Ethereum_MaintenanceGrantALRETRY_ROLEOnADI_20260525();
  }
