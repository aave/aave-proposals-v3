...
/**
 * @dev Test for AaveV4Ethereum_IncreaseCaps_20260811
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260811_Multi_AaveV4CapsIncreaseRound13/AaveV4Ethereum_IncreaseCaps_20260811.t.sol -vv
 */
contract AaveV4Ethereum_IncreaseCaps_20260811_Test is ProtocolV4TestBase {
  AaveV4Ethereum_IncreaseCaps_20260811 internal payload;
  ...
  function setUp() public virtual {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25689275);
    payload = new AaveV4Ethereum_IncreaseCaps_20260811();
  }
  ...
  function test_executeWithRecording() public virtual {
    string memory reportName = 'AaveV4Ethereum_IncreaseCaps_20260811';
  ...
  function test_caps_coreHub_before() public view virtual {
        ...
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.GOLD_SPOKE), AaveV4EthereumAssets.EURC_UNDERLYING, 0, 100_000
        );
        ...
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.MAIN_SPOKE), AaveV4EthereumAssets.WETH_UNDERLYING, 38_000, 3_300
        );
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.MAIN_SPOKE), AaveV4EthereumAssets.wstETH_UNDERLYING, 15_000, 0
        );
        _assertCaps(
            CORE_HUB,
            address(AaveV4EthereumSpokes.ETHENA_ECOSYSTEM_SPOKE),
            AaveV4EthereumAssets.frxUSD_UNDERLYING,
            0,
            1_000_000
        );
    }
  ...
  function test_caps_coreHub() public virtual {
        ...
        //                  hub       spoke                                                       asset                                       addCap      drawCap
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.GOLD_SPOKE), AaveV4EthereumAssets.EURC_UNDERLYING, 0, 200_000
        );
        _assertCaps(CORE_HUB, address(AaveV4EthereumSpokes.GOLD_SPOKE), AaveV4EthereumAssets.XAUt_UNDERLYING, 4_500, 0);
        _assertCaps(
            CORE_HUB,
            address(AaveV4EthereumSpokes.MAIN_SPOKE),
            AaveV4EthereumAssets.USDT_UNDERLYING,
        ...
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.MAIN_SPOKE), AaveV4EthereumAssets.WETH_UNDERLYING, 50_000, 3_300
        );
        _assertCaps(
            CORE_HUB, address(AaveV4EthereumSpokes.MAIN_SPOKE), AaveV4EthereumAssets.wstETH_UNDERLYING, 30_000, 0
        );
        _assertCaps(
            CORE_HUB,
            address(AaveV4EthereumSpokes.ETHENA_ECOSYSTEM_SPOKE),
  ...
  function test_caps_plusHub_before() public view virtual {
        ...
        _assertCaps(
            PLUS_HUB,
            address(AaveV4EthereumSpokes.ETHENA_ECOSYSTEM_SPOKE),
            AaveV4EthereumAssets.sUSDe_UNDERLYING,
            8_000_000,
            0
        );
    }
  ...
  function test_caps_globalDollarHub_before() public view virtual {
        ...
        _assertCaps(
            GLOBAL_DOLLAR_HUB,
            address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE),
        ...
        _assertCaps(
            GLOBAL_DOLLAR_HUB,
            address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE),
            AaveV4EthereumAssets.syrupUSDG_UNDERLYING,
            10_000_000,
            0
        );
    }
