...
/**
 * @dev Test for AaveV4Ethereum_IncreaseCaps_20260820
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260820_Multi_AaveV4CapsIncreaseRound14/AaveV4Ethereum_IncreaseCaps_20260820.t.sol -vv
 */
contract AaveV4Ethereum_IncreaseCaps_20260820_Test is ProtocolV4TestBase {
  AaveV4Ethereum_IncreaseCaps_20260820 internal payload;
  ...
  function setUp() public virtual {
    vm.createSelectFork(vm.rpcUrl('mainnet'), 25796365);
    payload = new AaveV4Ethereum_IncreaseCaps_20260820();
  }
  ...
  function test_executeWithRecording() public virtual {
    string memory reportName = 'AaveV4Ethereum_IncreaseCaps_20260820';
  ...
  function test_caps_coreHub_before() public view virtual {
        ...
        _assertCaps(CORE_HUB,  address(AaveV4EthereumSpokes.ETHENA_ECOSYSTEM_SPOKE), AaveV4EthereumAssets.frxUSD_UNDERLYING,    0,          2_000_000);
    }
  ...
  function test_caps_coreHub() public virtual {
        ...
        _assertCaps(CORE_HUB,  address(AaveV4EthereumSpokes.GOLD_SPOKE),             AaveV4EthereumAssets.GHO_UNDERLYING,       0,          1_000_000);
        _assertCaps(CORE_HUB,  address(AaveV4EthereumSpokes.MAIN_SPOKE),             AaveV4EthereumAssets.GHO_UNDERLYING,       12_000_000, 10_000_000);
  ...
  function test_caps_globalDollarHub_before() public view virtual {
        //          hub               spoke                                            asset                                      addCap      drawCap
        _assertCaps(GLOBAL_DOLLAR_HUB, address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE), AaveV4EthereumAssets.USDC_UNDERLYING,      1_000_000,  1_000_000);
        _assertCaps(GLOBAL_DOLLAR_HUB, address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE), AaveV4EthereumAssets.USDG_UNDERLYING,      20_000_000, 19_000_000);
        _assertCaps(GLOBAL_DOLLAR_HUB, address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE), AaveV4EthereumAssets.syrupUSDG_UNDERLYING, 20_000_000, 0);
    }
  ...
  function test_caps_globalDollarHub() public virtual {
        ...
        //          hub               spoke                                            asset                                      addCap      drawCap
        _assertCaps(GLOBAL_DOLLAR_HUB, address(AaveV4EthereumSpokes.USDG_MAPLE_ESPOKE), AaveV4EthereumAssets.USDC_UNDERLYING,      2_500_000,  2_500_000);
