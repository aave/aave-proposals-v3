...
/**
 * @dev Test for AaveV4Ethereum_IncreaseCaps_20260916
 * command: FOUNDRY_PROFILE=test forge test --match-path=src/20260916_Multi_AaveV4CapsIncreaseRound17/AaveV4Ethereum_IncreaseCaps_20260916.t.sol -vv
 */
contract AaveV4Ethereum_IncreaseCaps_20260916_Test is ProtocolV4TestBase {
  AaveV4Ethereum_IncreaseCaps_20260916 internal payload;
  ...
  function setUp() public virtual {
    ...
    payload = new AaveV4Ethereum_IncreaseCaps_20260916();
  }
  ...
  function test_executeWithRecording() public virtual {
    string memory reportName = 'AaveV4Ethereum_IncreaseCaps_20260916';
