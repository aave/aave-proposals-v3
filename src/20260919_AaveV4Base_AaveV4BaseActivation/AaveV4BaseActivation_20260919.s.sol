...
contract DeployBase is BaseScript {
  function run() external broadcast {
    ...
    address payload0 = GovV3Helpers.deployDeterministic(
      type(AaveV4Base_AaveV4BaseActivation_20260919).creationCode
    );
...
/**
 * @dev Create Proposal
 * command: make deploy-ledger contract=src/20260919_AaveV4Base_AaveV4BaseActivation/AaveV4BaseActivation_20260919.s.sol:CreateProposal chain=mainnet
 */
  ...
  function run() external {
    ...
    GovV3Helpers.createProposal(
      ...
      GovV3Helpers.ipfsHashFile(
        vm,
        'src/20260919_AaveV4Base_AaveV4BaseActivation/AaveV4BaseActivation.md'
      )
    );
  }
}
