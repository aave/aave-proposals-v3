...
This payload activates the Risk Steward on Aave V4 Arc, by setting its risk configuration and granting it the AccessManager and ACL manager roles it needs to operate.

The configuration is the one applied to the Aave V4 Risk Stewards on Ethereum and Avalanche, following LlamaRisk's recommendation.

## Motivation

The Arc V4 Risk Steward is deployed but holds no configuration and no permissions, so every risk parameter change on the Arc market still requires the Security Council to execute a dedicated payload.

Applying the same configuration as on Ethereum and Avalanche keeps a single risk mandate across the V4 deployments: the same limits on how far a single update can move a parameter, and the same cooldowns.
...
They are provided as a single Safe Transaction Builder batch in [AaveV4ArcRiskStewardsActivation_SafeTxBundle.json](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20260923_AaveV4Arc_AaveV4ArcRiskStewardsActivation/AaveV4ArcRiskStewardsActivation_SafeTxBundle.json).
...
- Implementation: [AaveV4Arc_AaveV4ArcRiskStewardsActivation_20260923](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20260923_AaveV4Arc_AaveV4ArcRiskStewardsActivation/AaveV4Arc_AaveV4ArcRiskStewardsActivation_20260923.sol)
- Tests: [AaveV4Arc_AaveV4ArcRiskStewardsActivation_20260923](https://github.com/aave-dao/aave-proposals-v3/blob/main/src/20260923_AaveV4Arc_AaveV4ArcRiskStewardsActivation/AaveV4Arc_AaveV4ArcRiskStewardsActivation_20260923.t.sol)
- [Snapshot](https://snapshot.org/#/s:aavedao.eth/proposal/0xf736fa5f6dd1532d0e2825fe528262479949a923427989384e313490ca9d9f18)
